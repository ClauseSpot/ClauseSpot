    ...
    <div className="w-full flex items-center justify-center py-8 px-4">
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Button className="w-full mx-3 bg-[#1A365D] text-white py-3 rounded-md hover:opacity-90 hover:bg-[#1A365D] transition-opacity">
            Adicionar Arquivo
          </Button>
        </DialogTrigger>
        ...
        <DialogContent className="w-full max-w-2xl rounded-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Preencha os campos abaixo e envie o documento.
            </DialogDescription>
          </DialogHeader>
