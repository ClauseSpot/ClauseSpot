...
export const SecaoDeBusca = ({ termoDeBusca, setTermoDeBusca, filtroAberto, toggleFiltro, handleBusca, handleLimpar }: SearchSectionProps) => {
  return (
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button onClick={toggleFiltro} 
                className={twMerge(clsx('text-white', !filtroAberto && 'bg-orange-400 hover:bg-orange-500'))}
                style={filtroAberto ? { backgroundColor: '#2c5582' } : {}}
              >
            ...
            {termoDeBusca && (
              <div className="mt-6 p-6 rounded-lg bg-blue-50 border border-blue-200">
                ...
                <p className="text-gray-600">Buscando por: "<strong className="text-blue-600">{termoDeBusca}</strong>"</p>
              </div>
            )}
          </div>
        </CardContent>
